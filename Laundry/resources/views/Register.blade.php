            ...
            <div class="card-body">
              ...
              <form class="form-signin" action="{{ url('daftar') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama" class="form-control form-control-lg" placeholder="Nama Kasir" required>
                </div>
                ...
                <div class="form-group" style="margin: 20px;">
                  <div class="form-check form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" name="role" class="form-check-input-lg" value="Kasir"> Kasir
                    </label>
                  </div>

                  <div class="form-check form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" name="role" class="form-check-input-lg" value="Owner"> Owner
                    </label>
                  </div>
                </div>
